...
public class MainActivity extends Activity {
    ...
    final int MAX_SEC= 15; // (seconds) lifetime for background thread
...
//testing thread’s termination
            if(bar1.getProgress() == MAX_SEC){
                ...
                msgWorking.setVisibility(View.GONE);
                msgReturned.setVisibility(View.GONE);
